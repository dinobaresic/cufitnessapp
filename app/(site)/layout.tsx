...
export default function SiteLayout({
    ...
    return (
        <div className={`${oswald.variable} ${outfit.variable} font-body bg-background text-foreground antialiased selection:bg-accent/30 selection:text-accent relative`}>
            <BackgroundOrbs />
            <Header />
