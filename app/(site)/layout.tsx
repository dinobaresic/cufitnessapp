...
export default function SiteLayout({
    ...
    return (
        <html lang="hr" className={`${oswald.variable} ${outfit.variable}`}>
            <body className="font-body bg-background text-foreground antialiased selection:bg-accent/30 selection:text-accent relative">
                <BackgroundOrbs />
                <Header />
